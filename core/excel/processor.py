...
COLUMN_ALIASES = {
    ...
    'submission_route': 'submission_route', '提交路由': 'submission_route', '上架路线': 'submission_route',
    ...
    'batteries_required': 'batteries_required', '需要电池': 'batteries_required',
    'batteries_included': 'batteries_included', '含电池': 'batteries_included',
    'supplier_declared_dg_hz_regulation': 'supplier_declared_dg_hz_regulation', '危化品监管声明': 'supplier_declared_dg_hz_regulation',
    ...
    'capacity': 'capacity', '容量': 'capacity', 'Capacity': 'capacity',
    'included_components': 'included_components', '包含组件': 'included_components', 'Included Components': 'included_components',
    'care_instructions': 'care_instructions', '护理说明': 'care_instructions', 'Care Instructions': 'care_instructions',
    'special_feature': 'special_feature', '特殊功能': 'special_feature', 'Special Feature': 'special_feature',
...
_ALIAS_TARGET_TO_DETECT = {
    ...
    'closure_type': 'closure_type', 'capacity': 'capacity',
    'included_components': 'included_components', 'care_instructions': 'care_instructions',
    'special_feature': 'special_feature', 'unit_count': 'unit_count',
...
class ExcelProcessor:
    ...
    def detect_columns(self) -> Dict[str, Optional[str]]:
        ...
        keywords_map = {
            ...
            'submission_route': ['submission_route', '提交路由', '上架路线'],
            ...
            'batteries_required': ['batteries_required', '需要电池', 'are_batteries_required'],
            'batteries_included': ['batteries_included', '含电池', 'are_batteries_included'],
            'supplier_declared_dg_hz_regulation': ['supplier_declared_dg_hz_regulation', '危化品监管声明', 'hazmat_declaration'],
            ...
            'included_components': ['included_components', '包含组件'],
            'care_instructions': ['care_instructions', '护理说明'],
            'special_feature': ['special_feature', '特殊功能'],
