...
print("  WBE-001: 1 Parent + 3 Children (Color)")
print("  SSB-002: 1 Parent + 4 Children (SizeName-ColorName)")
print("  PHC-005: 1 Parent + 2 Children (Color)")
print("  LED-003-WHT: Standalone")
print("  GBX-004-DLX: Standalone")
print("  YGM-006-PP:  Standalone (FBA)")
