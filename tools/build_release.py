...
def _write_mac_launcher(target_dir: Path) -> None:
    ...
    launcher.write_text(
        ...
        "echo \"==============================================\"\n"
        "echo\n"
        "echo \"  ★ 第一次打开会弹「无法验证开发者」？\"\n"
        "echo \"    1) 关掉那个弹窗\"\n"
        "echo \"    2) 在文件上点 鼠标右键 → 选「打开」→ 再点「打开」\"\n"
        "echo \"    （只需要这样做一次，以后双击就行）\"\n"
        "echo\n"
        "echo \"  ★ 请不要关闭这个黑窗口；关闭它=关闭软件\"\n"
        "echo \"==============================================\"\n"
        "echo\n"
        "echo \"正在检测运行环境...\"\n"
...
def _write_windows_launcher(target_dir: Path) -> None:
    ...
    launcher.write_text(
        ...
        "echo ==============================================\r\n"
        "echo.\r\n"
        "echo   * Windows 弹「Windows 已保护你的电脑」？\r\n"
        "echo     点窗口里的「更多信息」-^> 点「仍要运行」即可\r\n"
        "echo     （只需要这样做一次，以后双击就行）\r\n"
        "echo.\r\n"
        "echo   * 杀毒软件提示拦截？请在杀毒软件里把本程序加入「信任名单」\r\n"
        "echo.\r\n"
        "echo   * 请不要关闭这个黑窗口；关闭它=关闭软件\r\n"
        "echo ==============================================\r\n"
        "echo.\r\n"
